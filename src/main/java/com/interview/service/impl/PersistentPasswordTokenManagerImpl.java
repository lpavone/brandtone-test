...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.interview.service.impl.PasswordTokenManager#generateRecoveryToken(com.interview.model.User)
     */
    @Override
    ...
    /**
     * @see com.interview.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.interview.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.interview.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
